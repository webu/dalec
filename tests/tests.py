...
class DalecTests(TestCase):
    ...
    def test_overrided_settings_app(self):
        ...
        self.assertEqual(app_settings.get_for("NB_CONTENTS_KEPT", "exemple", "quarter"), 15)
        self.assertEqual(app_settings.get_for("NB_CONTENTS_KEPT", "exemple", "french_educ"), 20)
        self.assertEqual(app_settings.get_for("NB_CONTENTS_KEPT", "exemple", "content-type"), 30)
    ...
    def test_missing_dalec_prime(self):
        with self.assertRaisesRegex(ValueError, "adding dalec_prime to your INSTALLED_APPS"):
    ...
    def test_standard_template_tags(self):
        ...
        url = reverse("dalec_fetch_content", kwargs={
            "app": "exemple",
            "content_type": "hour",
            "channel": "quarter",
        })
